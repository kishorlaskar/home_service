...
--
-- Host: localhost:3306
-- Generation Time: Mar 26, 2019 at 09:48 AM
...
--
-- Database: `shunnoso_home_service`
--
...
CREATE TABLE `bookings` (
  ...
  `status` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '<span class="btn-primary">pending</span>',
  `rank` double(8,2) DEFAULT 0.00,
...
(2, 1, 3, 7, '<span class=\"btn-success\">Complete</span>', 0.00, NULL, '2019-03-20 22:04:00', '2019-03-15 04:22:51', '2019-03-26 23:30:44'),
(3, 1, 3, 6, '<span class=\"btn-info\" style=\"background-color:#8ecc17\">Accept</span>', 0.00, NULL, '2019-03-28 19:21:00', '2019-03-26 12:00:09', '2019-03-26 23:30:34');
...
(1, 'customer', 'customer@gmail.com', '$2y$10$9bdPVQqBAU4VqNblRNZcyOQj50quvtZBdpCu9gMP1v3vJOfpBvVHG', 'mirpur-2,Dhaka', '222244444', '1.jpg', '2019-03-02 14:30:38', '2019-03-20 03:59:10'),
(2, 'customer1', 'customer1@gmail.com', '$2y$10$9bdPVQqBAU4VqNblRNZcyOQj50quvtZBdpCu9gMP1v3vJOfpBvVHG', 'saver,Dhaka', '012546636', NULL, NULL, NULL);
...
(3, 'Service Provider', 'service_provider@gmail.com', '$2y$10$9bdPVQqBAU4VqNblRNZcyOQj50quvtZBdpCu9gMP1v3vJOfpBvVHG', 'mirpur-1,Dhaka', '1111111111', '3.jpg', '2019-03-02 14:12:01', '2019-03-20 04:29:51'),
(4, 'service Provider1', 'service_provider1@gmail.com', '$2y$10$9bdPVQqBAU4VqNblRNZcyOQj50quvtZBdpCu9gMP1v3vJOfpBvVHG', 'saver,Dhaka', '8796143523', NULL, NULL, '2019-03-02 14:12:01');
...
(3, 3, 16, 9, '2019-03-19 16:32:09', '2019-03-19 16:32:09');
